...
path = 'C:\\Users\\patel_saurabh_j\\OneDrive\\001_Personal_Porfolio_Python_code\\ETF Global Challenge\\Spring 2017\\'

store_data = path + "MyPorfolio_Stock_Data_MSR_MIN.h5"

#%%
#
tickers = ('CNTR', 'PSCC', 'CSLS', 'PXSV', 'WMW', 'EQWM', 'HACK', 'IYK', 'ERUS', 'URA', '^GSPC')
